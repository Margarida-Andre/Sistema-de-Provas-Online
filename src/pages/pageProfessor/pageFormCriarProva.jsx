...
import { Dashboard, Header } from '../../styles/pageProfessor/styleCriarFormProva';
...
function pageCriarProva(){
  return(
    ...
    <section>
      ...
      <article id="article2">
          <form>
            <h1 id="h1">Cria uma nova prova</h1>
            <input type="text" placeholder="Título" class="formProva"></input>
            <Link to="pagePerguntasForm" className="link"><input type="submit" value="Criar nova pergunta" id="submit"></input></Link>
          </form>

          <img src={Imag} alt="" id="ilustracaoProve"></img>
      </article>
